    ...
    <>
      ...
      <main id="continut" className="flex-1">
        <div className="mx-auto w-full max-w-2xl px-5 py-12 sm:px-8 sm:py-16">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight">Comenzile mele</h1>

          {rows.length === 0 ? (
            <div className="mt-8 rounded border border-dashed border-border p-10 text-center text-steel">
              Încă nu ai comenzi.{" "}
                ...
                <li key={order.id}>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <span
                        className={`rounded px-2 py-0.5 font-mono text-[0.65rem] ${ORDER_STATUS_BADGE[order.status]}`}
                      >
